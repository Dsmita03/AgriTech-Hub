...
const Forum = () => {
  ...
  useEffect(() => {
    const fetchPosts = async () => {
      setLoading(true);
      try {
        const response = await fetch("https://agritech-hub-backend.onrender.com/api/forum/posts");
  ...
  const fetchComments = async (postId) => {
    try {
      const response = await fetch(`https://agritech-hub-backend.onrender.com/api/forum/posts/${postId}/comments`);
      const data = await response.json();
      if (response.ok) {
  ...
  const handleCommentSubmit = async (e, postId) => {
    ...
    try {
      const response = await fetch(`https://agritech-hub-backend.onrender.com/api/forum/posts/${postId}/comment`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
